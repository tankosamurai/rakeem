    ...
    //     $mapper = new Rakeem\Controller\RakNetController($socket, $addr, $rakPacket);
        ...
        foreach($packets as $datPacket){
            ...
            if(false){
                ...
                $mapper = new Rakeem\Controller\PlayStatusController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\DisconnectController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\SetTimeController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\StartGameController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\AddPlayerController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\RemovePlayerController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\AddEntityController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\RemoveEntityController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\AddItemEntityController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\TakeItemEntityController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\MoveEntityController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\MovePlayerController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\RemoveBlockController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\UpdateBlockController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\AddPaintingController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\ExplodeController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\LevelEventController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\TileEventController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\EntityEventController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\MobEffectController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\PlayerEquipmentController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\PlayerArmorEquipmentController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\InteractController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\UseItemController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\PlayerActionController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\HurtArmorController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\SetEntityDataController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\SetEntityMotionController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\SetEntityLinkController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\SetHealthController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\SetSpawnPositionController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\AnimateController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\RespawnController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\DropItemController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\ContainerOpenController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\ContainerCloseController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\ContainerSetSlotController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\ContainerSetDataController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\ContainerSetContentController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\AdventureSettingsController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\TileEntityDataController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\FullChunkDataController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\SetDifficultyController($socket, $addr, $rakPacket, $datPacket, $appPacket);
                ...
                $mapper = new Rakeem\Controller\BatchController($socket, $addr, $rakPacket, $datPacket, $appPacket);
            }else{
                $mapper = new Rakeem\Controller\RakNetController($socket, $addr, $rakPacket);
            }
        }
